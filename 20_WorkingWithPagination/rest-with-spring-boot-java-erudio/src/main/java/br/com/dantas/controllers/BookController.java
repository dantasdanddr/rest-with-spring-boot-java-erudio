...
import br.com.dantas.data.vo.v1.BookVO;
import br.com.dantas.services.BookServices;
...
public class BookController {
	...
	public ResponseEntity<PagedModel<EntityModel<BookVO>>> findAll(
		...
		var sortDirecation = "desc".equalsIgnoreCase(direction) ? Direction.DESC : Direction.ASC;
		
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirecation, "author"));
